...
const Footer = () => {
  ...
  const XIcon = () => (
    ...
    >
      <path
        d="M16.99 3H20.25L13.88 10.37L21.51 21H15.37L10.73 14.89L5.46 21H2.2L9.02 13.11L1.69 3H7.96L12.16 8.59L16.99 3ZM16.16 19.19H17.98L7.13 4.72H5.17L16.16 19.19Z"
        stroke="#90A1B9"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
  ...
  const linkSections = [
    {
      title: "PRODUCTS",
      links: [
        { text: "Baby Cloths", path: "/", icon: null },
        { text: "Baby Care", path: "/", icon: null },
        { text: "Baby Electronics", path: "/", icon: null },
        { text: "Baby Toys", path: "/", icon: null },
      ],
    },
    {
      title: "WEBSITE?",
    ...
    },
    {
      title: "CONTACT",
      links: [
        { text: "+1-437-778-1049", path: "/", icon: MailIcon },
        { text: "whehddjs@gmail.com", path: "/", icon: PhoneIcon },
        { text: "794 Yonge Street, M2M3L1", path: "/", icon: MapPinIcon },
      ],
    },
  ];

  const socialIcons = [
    { icon: FacebookIcon, link: "https://www.facebook.com/dongun.cho.5" },
    { icon: InstagramIcon, link: "https://www.instagram.com/donguncho/" },
    { icon: XIcon, link: "https://x.com/" },
    {
      icon: LinkedinIcon,
      link: "https://www.linkedin.com/in/daniel-cho-450b041b4/",
    },
  ];
    ...
    <footer className="mx-6 bg-white">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-slate-500/30 text-slate-500">
          <div>
            <Link href="/" className="text-4xl font-semibold text-slate-700">
              <span className="text-green-600">Baby</span>Event
              <span className="text-green-600 text-5xl leading-0">.</span>
            </Link>
            <p className="max-w-[410px] mt-6 text-sm">
              Welcome to BabyEvent, your ultimate destination for all things
              baby! We are dedicated to providing parents and caregivers with a
              wide range of high-quality products and resources to support you
        ...
        <p className="py-4 text-sm text-slate-500">
          Copyright 2025 © BabyEvent All Right Reserved.
        </p>
      </div>
    </footer>
  );
